...
class PokemonItem(private val pokemonID: Int) {
    ...
    var spriteURL: String? = null // TODO will come in use later
     ...
     */
    private suspend fun getPokemonType1() {
    ...
    private suspend fun getPokemonType2() {
        val typesArr = parseJSONObj(webPage,"types")
     ...
     * Post:  Parses through the JSON file to find the type in the JSON data
     */
    private suspend fun getPokemonSprite() {
